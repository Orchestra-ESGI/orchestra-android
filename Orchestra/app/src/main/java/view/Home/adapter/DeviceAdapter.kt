...
import view.Detail.Device.DetailDeviceActivity
...
class DeviceAdapter(listener : OnDeviceListener) : RecyclerView.Adapter<DeviceAdapter.DeviceViewHolder>(){
    ...
    class DeviceViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(device: Device, listener: OnDeviceListener) {
            when(device.type) {
                DeviceType.lightbulb -> objectIcon.setImageResource(R.drawable.ic_lightbulb)
                DeviceType.switch -> objectIcon.setImageResource(R.drawable.ic_switch)
                DeviceType.sensor -> objectIcon.setImageResource(R.drawable.ic_sensor)
                DeviceType.occupancy -> objectIcon.setImageResource(R.drawable.ic_sensor)
                DeviceType.contact -> objectIcon.setImageResource(R.drawable.ic_contact)
                DeviceType.programmableswitch -> objectIcon.setImageResource(R.drawable.ic_programmable_switch)
                DeviceType.temperatureandhumidity -> objectIcon.setImageResource(R.drawable.ic_temperature)
